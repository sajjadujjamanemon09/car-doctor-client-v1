  ...
  return (
    <div className="carousel w-full h-[600px]">
      ...
      <div className="text-white space-y-7 w-1/2 pl-16">
        <h1 className="text-6xl font-bold">Affordable Price For Car Servicing
        </h1>
        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
        <div>
        <button className="btn btn-active bg-red-500 border-none text-white mr-5">Discover More</button>
